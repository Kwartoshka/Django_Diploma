...
@pytest.mark.parametrize(
    ['authorized', 'is_admin', 'status', 'order_sum', 'order_sum__lt', 'order_sum__gt', 'created_at', 'created_before',
     'created_after', 'updated_at', 'updated_before', 'updated_after', 'product', 'expected_status', 'length'],
    (
            ...
            (True, True, '', '', '', '', '', '', '', '', '1971-12-12', '', '', HTTP_200_OK, 0),
            (True, True, '', '', '', '', '', '', '', '', '2035-12-12', '', '', HTTP_200_OK, 1),

            (True, True, '', '', '', '', '', '', '', '', '', '2035-12-12', '', HTTP_200_OK, 0),
            (True, True, '', '', '', '', '', '', '', '', '', '1971-12-12', '', HTTP_200_OK, 1),
...
@pytest.mark.django_db
def test_get_orders(authorized, is_admin, status, order_sum, order_sum__lt, order_sum__gt, created_at, created_before,
                    created_after, updated_at, updated_before, updated_after, product, expected_status, length):
    client = APIClient()
